...
import { sendMessage as getModelRes, fetchChatsBySectionName } from '../../actions/messageActions.js';
...
const RightSection = () => {
            ...
            const chats = allMessages.map((msg, index) => (
                <div key={index} className={styles.message}>
                    ...
                    <div className={styles.details}>
                        ...
                        <p className={styles.msg}>{msg?.text}</p>
                    </div>
                </div>
            ));
    ...
    const getModelResponse = async() => {
        await getModelRes(message, CurrentSection, dispatch).then((data) => {
            setAllMessages(data);
            return data;
        }).then((data) => {
            reRenderChats();
        ...
        <div className={styles.rightSection}>
            <div className={styles.rightin}>
                <div className={styles.chatgptversion}>
                    ...
                    {
                        isWideScreen && <>
                            <div className={styles.shareddocpfp} onMouseEnter={() => console.log("Hovered")} >
                                <img className={styles.oneshareddocpfp} src={nouserlogo} width={20} height={20} alt="" />
                                <img className={styles.oneshareddocpfp} src={nouserlogo} width={20} height={20} alt="" />
                                <img className={styles.oneshareddocpfp} src={nouserlogo} width={20} height={20} alt="" />
                                <img className={styles.oneshareddocpfp} src={nouserlogo} width={20} height={20} alt="" />
                            </div>
                            <button className={styles.shareButton}>Share Medical History</button>
                            <button className={styles.contactButton} onClick={() => window.location.href=`/contact/${CurrentSection}`}>
                ...
                <div className={styles.bottomsection}>
                    <div className={styles.messagebar}>
                        <input type='text' placeholder='To Your Doc...'
